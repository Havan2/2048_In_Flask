...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Assignment1", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Assignment1", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Assignment1";
		app.meta["name"] = "Assignment1";
